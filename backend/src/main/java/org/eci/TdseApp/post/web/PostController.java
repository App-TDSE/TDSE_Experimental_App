package org.eci.TdseApp.post.web;
...
import org.eci.TdseApp.post.service.PostService;
import org.eci.TdseApp.post.web.dto.CreatePostRequest;
import org.eci.TdseApp.post.web.dto.PostResponse;
import org.eci.TdseApp.post.web.dto.UpdatePostRequest;
...
public class PostController {
    ...
    public ResponseEntity<PostResponse> createPost(@Valid @RequestBody CreatePostRequest request, @AuthenticationPrincipal Jwt jwt) {
        UserEntity user = userService.getOrCreateFromJwt(jwt);

        Post created = postService.createPost(jwt.getSubject(), user.getName(), request.content());
